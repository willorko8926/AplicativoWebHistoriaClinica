        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Crear Nuevo Registro de Consulta</h4>
            </div>
          </div>
...
<!--Cabecera de la Tabla-->
    <form action="atencionConsultasDML.php?tipoOperacion=1" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
                <input type="text" name="txtCodUMedica"><br>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2 col-sm-2">
            ...
            <div class="col-md-4 col-sm-4">
                <input type="text" name="txtCodMedico"><br>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2 col-sm-2">
            ...
            <div class="col-md-4 col-sm-4">
                <input type="text" name="txtFechaAtencion"><br>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2 col-sm-2">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
                <input type="text" name="txtDiagnostico"><br>
            </div>
        </div>
        <div class="row">
            <div class="col-md-5 col-sm-5">
              <button type="submit" class="btn btn-app">Guardar</button> <a href="atencionConsultas.php">Cancelar</a><br>
        </div>
    </div>
  </form>
<!--************************************************************************************-->
