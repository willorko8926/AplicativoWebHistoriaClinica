        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Administración de Contacto</h4>
            </div>
          </div>
...
<!--Cabecera de la Tabla-->
         <form action="../../admin.php" method="POST">
              <table id="examen-list"> 
                <tr>
                    <th class="col-center">Num. Contacto</th>
                    <th class="col-left">Nombres</th>
                    <th class="col-left">Correo electrónico</th>
                    <th class="col-left">Asunto</th>
                    <th class="col-left">Mensaje</th>
                    <th class="col-center"><a href="contactoCreate.php" style="color:white">CREAR CONTACTO</a></th>
    </tr>
<!--************************************************************************************-->
<!--Detalle de la Tabla-->
<?php
    ...
    foreach ($lobContactoCollector->selectALL() as $r){
        ...
        echo "    <td class='col-center'>".$r->getNumeroContacto()."</td>";
        echo "    <td class='col-left'>".$r->getNombres()."</td>";
        echo "    <td class='col-left'>".$r->getCorreoElectronico()."</td>";
        echo "    <td class='col-left'>".$r->getAsunto()."</td>";
        echo "    <td class='col-left'>".$r->getMensaje()."</td>";
        echo "    <td class='col-center'><a href='contactoEdit.php?id=".$r->getNumeroContacto()."'>Editar</a> <a href='contactoDML.php?id=".$r->getNumeroContacto()."&tipoOperacion=3'>Eliminar</a></td>";
        echo "</tr>";
    }
?>
    </table>
