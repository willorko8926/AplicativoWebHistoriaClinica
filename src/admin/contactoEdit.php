        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Edición de Contacto</h4>
            </div>
          </div>
...
<!--Cabecera de la Tabla--> 
    ...
    <form action="contactoDML.php?tipoOperacion=2" method="post">
        ...
        <input type="text" name="txtNumContacto" value="<?php echo $lobContacto->getNumeroContacto(); ?>" readonly><br>
        </div>
            </div>
            <div class="row">
              <div class="col-md-2 col-sm-2">
        ...
        <button type="submit" class="btn btn-app">Actualizar</button> <a href="contacto.php">Cancelar</a>
              </div>
            </div>
          </form>
<!--************************************************************************************-->
