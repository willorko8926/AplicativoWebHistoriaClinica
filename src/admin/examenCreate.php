        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Crear Registro de Usuario</h4>
            </div>
          </div>
...
<!--Cabecera de la Tabla-->
          <form action="examenDML.php?tipoOperacion=1" method="post">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtcodigo_institucion"><br>
              </div>
            </div>
            <div class="row">
              <div class="col-md-2 col-sm-2">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtcodigo_medico"><br>
              </div>
            </div>
            <div class="row">
              <div class="col-md-2 col-sm-2">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtfecha_examen"><br>
              </div>
            </div>
            <div class="row">
              <div class="col-md-2 col-sm-2">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txttipo_examen"><br>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtconsideraciones_examen"><br>
              </div>
            </div>
             <div class="row">
              <div class="col-md-2 col-sm-2">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtexplicacion_examen"><br>
              </div>
            </div>
            
            <div class="row">
              <div class="col-md-5 col-sm-5">
                <button type="submit" class="btn btn-app">Guardar</button> <a href="examen.php">Cancelar</a><br>
              </div>
            </div>
          </form>
<!--************************************************************************************-->
