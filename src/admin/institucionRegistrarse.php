...
<!--Cabecera de la Tabla-->
          <form action="../../admin.php" method="POST">
              <table id="examen-list">
                <tr>
                  <th class="col-center">Cod.Isnti.</th>
                  <th class="col-left">Nombres</th>
                  <th class="col-left">Razon Social</th>
                  <th class="col-center"><a href="institucionRegistrarseCreate.php" style="color:white">Crear</a></th>
                </tr>
<!--************************************************************************************-->
<!--Detalle de la Tabla-->
...
<?php
    ...
    foreach ($lobRegInstitucionCollector->selectALL() as $r){
        echo "<tr>";
        echo "    <td class='col_center'>".$r->getCodigoInstitucion()."</td>";
        echo "    <td class='col_left'>".$r->getNombre()."</td>";
        echo "    <td class='col_left'>".$r->getRazonSocial()."</td>";
        echo "    <td class='col-center'><a href='institucionRegistrarseEdit.php?id=".$r->getCodigoInstitucion()."'>Editar</a> <a href='institucionRegistrarseDML.php?id=".$r->getCodigoInstitucion()."&tipoOperacion=3'>Eliminar</a></td>";
        echo "</tr>";
    }
?>
    </table>
