        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Crear Nuevo País</h4>
            </div>
          </div>
        ...
        <div class="row">
           <div class="col-md-2 col-sm-2">
            ...
            <div class="col-md-4 col-sm-4">
                <input type="text" name="txtCodPais" autofocus><br>
            </div>
            </div>
            <div class="row">
              <div class="col-md-2 col-sm-2">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtNomPais"><br>
               </div>
            </div>
            <div class="row">
              <div class="col-md-5 col-sm-5">
                <button type="submit" class="btn btn-app">Guardar</button> <a href="pais.php">Cancelar</a><br>
              </div>
            </div>
          </form>
<!--************************************************************************************-->
