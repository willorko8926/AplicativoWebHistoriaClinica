      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-6">
            <div class="block">
              <h1>MedikalHCE©</h1>
              <h1>Administración Persona Contacto</h1>
            </div>
          </div>
          <div class="col-md-6 col-sm-6">
            <div class="block">
        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Registro de Persona Contacto</h4>
            </div>
          </div>
          ...
          <form action="../../admin.php" method="POST">
            ...
            <th>Correo Electronico</th>
             <th>Codigo de Pais</th>
                <th class="col-center"><a href="personaContactoCreate.php" style="color:white">Crear</a></th>
