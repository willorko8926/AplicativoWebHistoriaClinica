          ...
          <form action="registrarseDML.php?tipoOperacion=1" method="post">
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtIdentificacion" autofocus><br>
              </div>
            </div>
            <div class="row">
              <div class="col-md-2 col-sm-2">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtCodigoPais"><br><br>
              </div>
            </div>
            <div class="row">
              <div class="col-md-5 col-sm-5">
                <button type="submit" class="btn btn-app">Guardar</button> <a href="registrarse.php">Cancelar</a><br>
              </div>
            </div>
          </form>
<!--************************************************************************************-->
