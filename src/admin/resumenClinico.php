        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Resumen Clínico de Ciudadanos</h4>
            </div>
          </div>
...
<!--Cabecera de la Tabla-->
          <form action="../../admin.php" method="POST">
              <table id="examen-list">
                <tr>
                  <th class="col-left">Cód.Persona</th>
                  <th class="col-left">Nombres</th>
                  <th class="col-left">Enfermedades</th>
                  <th class="col-left">Diagnósticos Recientes</th>
                  <th class="col-center"><a href="resumenClinicoCreate.php" style="color:white">Crear</a></th>
                </tr>
<!--************************************************************************************-->
<!--Detalle de la Tabla-->
            <?php
              ...
              foreach ($lobResumClinicoCollector->selectALL() as $r){
                $lobPersonaCollector = new CPersonaCollector();
                $lobPersona = $lobPersonaCollector->selectPK($r->getCodigoPersona());
                //$lstEnfermedades = ;
                //$lstDiagnosticos = ;
                echo "<tr>";
                echo "    <td class='col-left'>".$r->getCodigoPersona()."</td>";
                echo "    <td class='col-left'>".$lobPersona->getApellidos()." ".$lobPersona->getNombres()."</td>";
                echo "    <td class='col-left'>".substr($r->getEnfermedadesImportantes(),0,50)."...</td>";
                echo "    <td class='col-left'>".substr($r->getDiagnosticosRecientes(),0,50)."...</td>";
                echo "    <td class='col-center'><a href='resumenClinicoEdit.php?id=".$r->getCodigoPersona()."'>Editar</a> <a href='resumenClinicoDML.php?id=".$r->getCodigoPersona()."&tipoOperacion=3'>Eliminar</a></td>";
                echo "</tr>";
              }
            ?>
              </table>
