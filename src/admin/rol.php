        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Administración de Roles</h4>
            </div>
          </div>
<!--************************************************************************************-->
...
<!--Cabecera de la Tabla-->
          <form action="../../admin.php" method="POST">
              <table id="examen-list">
                <tr>
                    <th class="col-center">Código Rol</th>
                    <th class="col-left">Descripción</th>
                    <th class="col-center"><a href="rolCreate.php" style="color:white">CREAR ROL</a></th>
    </tr>
<!--************************************************************************************-->
<!--Detalle de la Tabla-->
<?php
    ...
    foreach ($lobRolCollector->selectALL() as $r){
        echo "<tr>";
        echo "    <td class='col-center'>".$r->getCodigoRol()."</td>";
        echo "    <td class='col-left'>".$r->getDescripcion()."</td>";
        echo "    <td class='col-center'><a href='rolEdit.php?id=".$r->getCodigoRol()."'>Editar</a> <a href='rolDML.php?id=".$r->getCodigoRol()."&tipoOperacion=3'>Eliminar</a></td>";
        echo "</tr>";
    }
?>
    </table>
