        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Crear Nuevo Rol</h4>
            </div>
          </div>
...
<!--Cabecera de la Tabla-->
    <form action="rolDML.php?tipoOperacion=1" method="post">
        ...
        <input type="text" name="txtCodRol" autofocus><br>
        </div>
            </div>
            <div class="row">
              <div class="col-md-2 col-sm-2">
        ...
        <input type="text" name="txtDescripcion"><br>
            ...
            <div class="row">
              <div class="col-md-5 col-sm-5">
                <button type="submit" class="btn btn-app">Guardar</button> <a href="rol.php">Cancelar</a><br>
              </div>
            </div>
          </form>
<!--************************************************************************************-->
