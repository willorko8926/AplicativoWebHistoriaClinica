        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Roles del Sistema Por Usuario</h4>
            </div>
          </div>
          ...
          <form action="../../admin.php" method="POST">
              <table id="examen-list">
                <tr>
                  ...
                  <th class="col-left">Código Rol</th>
                  <th class="col-center"><a href="rolxusuarioCreate.php" style="color:white">Crear</a></th>
                </tr>
<!--************************************************************************************-->
<!--Detalle de la Tabla-->
            <?php
              ...
              foreach ($lobRolUsuarioCollector->selectALL() as $r){
                echo "<tr>";
                echo "    <td class='col-left'>".$r->getCodigoUsuario()."</td>";
                echo "    <td class='col-left'>".$r->getCodigoRol()."</td>";
                echo "    <td class='col-center'><a href='rolxusuarioDML.php?idUsuario=".$r->getCodigoUsuario()."&idRol=".$r->getCodigoRol()."&tipoOperacion=3'>Eliminar</a></td>";
                echo "</tr>";
              }
            ?>
              </table>
