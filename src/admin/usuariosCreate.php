        ...
        <div class="block">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h4 class="underline">Crear Nuevo Usuario</h4>
            </div>
          </div>
...
<!--Cabecera de la Tabla-->
          <form action="usuariosDML.php?tipoOperacion=1" method="post">
            <div class="row">
              <div class="col-md-2 col-sm-2">
                <label>Código Usuario: </label>
              </div>
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtCodigoUsuario" autofocus required><br>
              </div>
            </div>
            <div class="row">
              <div class="col-md-2 col-sm-2">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtClaveUsuario" required><br>
              </div>
            </div>
            <div class="row">
              <div class="col-md-2 col-sm-2">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtCodigoPersona" required><br>
              </div>
            </div>
            <div class="row">
              <div class="col-md-2 col-sm-2">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="text" name="txtEstadoUsuario" required><br>
              </div>
            </div>
            <div class="row">
              <div class="col-md-5 col-sm-5">
                <button type="submit" class="btn btn-app">Guardar</button> <a href="usuarios.php">Cancelar</a><br>
              </div>
            </div>
          </form>
<!--************************************************************************************-->
